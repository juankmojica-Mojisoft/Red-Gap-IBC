...
const DashboardLiderMentor: React.FC<DashboardLiderMentorProps> = ({ onNavegar }) => {
  ...
  // Obtener GAPs bajo la responsabilidad del líder mentor
  const misGAPs = useMemo(() => {
    if (!usuario) return [];
    return getGAPsByLiderMentor(usuario.id);
  }, [usuario]);
  
  // Obtener líderes y timoteos bajo su supervisión
        ...
        <CardContent>
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3">
            ...
            >
              ...
              <span className="text-xs text-center">Crear Líder</span>
            </Button>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-sm text-gray-600">
                          <div>
                            <span className="text-gray-400">Líder:</span> {gap.liderGapNombre}
                          </div>
                          <div>
                            <span className="text-gray-400">Timoteo:</span> {gap.timoteoNombre}
                          </div>
                          <div>
                            <span className="text-gray-400">Día:</span> {gap.diaReunion}
                          </div>
                          <div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="p-4 bg-gray-50 rounded-lg text-center">
            ...
            <p className="text-sm text-gray-500">Gestiona las peticiones de oración de tus GAPs</p>
            <Button 
