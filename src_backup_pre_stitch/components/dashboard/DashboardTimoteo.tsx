...
const DashboardTimoteo: React.FC<DashboardTimoteoProps> = ({ onNavegar }) => {
  ...
  const [tareas, setTareas] = useState([
    { id: 1, titulo: 'Confirmar asistencia para reuniÃ³n', completada: false, prioridad: 'alta' },
    { id: 2, titulo: 'Preparar material de enseÃ±anza', completada: true, prioridad: 'media' },
    { id: 3, titulo: 'Contactar miembros ausentes', completada: false, prioridad: 'media' },
    { id: 4, titulo: 'Enviar recordatorio de reuniÃ³n', completada: false, prioridad: 'baja' },
  ]);
  ...
  const estadisticasAsistencia = useMemo(() => {
    ...
    const totalMiembros = miembros.length + 2; // +2 por lÃ­der y timoteo
  ...
  // Material de enseÃ±anza mÃ¡s reciente
      ...
      >
        ...
        <div className="relative z-10 flex items-start justify-between">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl font-bold">Â¡Hola, {usuario?.nombre}!</h2>
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-3">
                <div className="p-3 bg-gray-50 rounded-lg">
                  <p className="text-xs text-gray-500">CÃ³digo</p>
                ...
                <div className="p-3 bg-gray-50 rounded-lg col-span-2">
                  <p className="text-xs text-gray-500">LÃ­der del GAP</p>
              ...
              {miGAP.reunionConfirmada && (
                <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-sm font-medium text-green-800">ReuniÃ³n confirmada</p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-orange-600 mt-1">
                  No olvides confirmar la asistencia para la prÃ³xima reuniÃ³n del GAP.
                </p>
                <Button 
                  size="sm" 
          ...
          {miembros.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-sm text-gray-400 mt-2">
                Contacta a tu lÃ­der para agregar miembros al GAP
              </p>
            </div>
          ) : (
