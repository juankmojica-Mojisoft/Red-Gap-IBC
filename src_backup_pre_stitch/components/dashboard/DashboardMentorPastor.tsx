...
const eventosMock: Evento[] = [
  {
    ...
    descripcion: 'ReuniÃ³n mensual con todos los lÃ­deres de GAPs para revisar estadÃ­sticas y planificar actividades.',
    fecha: '2026-03-20',
    hora: '19:00',
    tipo: 'Reunion',
    prioridad: 'Alta',
  ...
  {
    id: 'evt2',
    titulo: 'CumpleaÃ±os - Juan PÃ©rez',
    descripcion: 'CelebraciÃ³n de cumpleaÃ±os del lÃ­der del GAP-1.',
    fecha: '2026-03-25',
    tipo: 'CumpleaÃ±os',
    prioridad: 'Media',
    creadorRol: 'pastor',
...
const DashboardMentorPastor: React.FC<DashboardMentorPastorProps> = ({ onNavegar }) => {
  ...
  // Calcular estadÃ­sticas de miembros
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6 animate-fade-in pb-24 lg:pb-6">
        ...
        <div className="relative z-10 flex items-start justify-between">
          <div>
            ...
            <p className="text-slate-500 mt-2">
              {misGAPs.length} GAPs â€¢ {totalMiembros} integrantes
            </p>
          </div>
      ...
      {/* Acciones rÃ¡pidas - Solo 6 opciones para Pastor */}
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            ...
            >
              ...
              <span className="text-xs font-medium">Crear LÃ­der GAP</span>
            </Button>
            <Button
              variant="outline"
            ...
            >
              ...
              <span className="text-xs font-medium">EnseÃ±anza</span>
            </Button>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-gray-400 mt-3 text-center">
            Haz clic en un dÃ­a para ver detalles o agregar un evento
          </p>
        </CardContent>
      </Card>
      ...
      <Dialog open={dialogoEventoAbierto} onOpenChange={setDialogoEventoAbierto}>
        <DialogContent className="max-w-lg">
          ...
          <div className="space-y-4">
            <div>
              <label className="text-sm font-medium text-gray-700 mb-1 block">TÃ­tulo *</label>
              <Input
            ...
            <div>
              <label className="text-sm font-medium text-gray-700 mb-1 block">DescripciÃ³n</label>
              <Textarea
              ...
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="ReunionGAP">ReuniÃ³n GAP</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gray-50 rounded-lg p-3">
                    <p className="text-sm text-gray-500 mb-1">ClasificaciÃ³n</p>
