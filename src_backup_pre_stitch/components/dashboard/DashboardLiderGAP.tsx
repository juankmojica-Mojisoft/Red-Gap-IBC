        ...
        <div className="relative z-10 flex items-start justify-between">
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-slate-500 text-sm font-medium">Rol: LÃ­der GAP</span>
            </div>
        ...
        <CardContent>
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3">
            ...
            >
              ...
              <span className="text-xs">EnseÃ±anzas</span>
            </Button>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="p-4 bg-gray-50 rounded-lg text-center">
            ...
            <p className="text-sm text-gray-500">Gestiona las peticiones de oraciÃ³n de tu GAP</p>
            <Button 
