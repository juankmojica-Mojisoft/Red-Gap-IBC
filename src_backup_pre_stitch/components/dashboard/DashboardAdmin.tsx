...
const logsSistema = [
  { id: 1, fecha: '2026-03-08 14:32:15', nivel: 'info', mensaje: 'Usuario pastor@ibc.org iniciÃ³ sesiÃ³n', modulo: 'Auth' },
  ...
  { id: 5, fecha: '2026-03-08 12:30:00', nivel: 'error', mensaje: 'Error de conexiÃ³n a base de datos (resuelto)', modulo: 'Database' },
  { id: 6, fecha: '2026-03-08 11:15:45', nivel: 'info', mensaje: 'Backup automÃ¡tico completado', modulo: 'Backup' },
  { id: 7, fecha: '2026-03-08 10:22:18', nivel: 'info', mensaje: 'Usuario admin@ibc.org cambiÃ³ configuraciÃ³n del tema', modulo: 'Config' },
  { id: 8, fecha: '2026-03-08 09:45:33', nivel: 'warning', mensaje: 'Solicitud de reset de contraseÃ±a recibida', modulo: 'Auth' },
];
...
const DashboardAdmin: React.FC<DashboardAdminProps> = ({ onNavegar }) => {
  ...
  const handleLimpiarCache = async () => {
    ...
    setLimpiando(false);
    toast.success('CachÃ© del sistema limpiado exitosamente');
  };
  ...
  const handleForzarBackup = async () => {
    ...
    toast.success('Â¡Backup completado exitosamente en Supabase!');
  };
    ...
    <div className="p-4 md:p-6 max-w-7xl mx-auto animate-fade-in pb-24 lg:pb-6">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Panel de AdministraciÃ³n TÃ©cnica</h1>
            <p className="text-gray-500">GestiÃ³n y mantenimiento del sistema G.A.P</p>
          </div>
        </div>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="p-4 bg-purple-50 rounded-lg">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-sm text-gray-600">VersiÃ³n</span>
                  </div>
            ...
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="flex items-center gap-2 text-base">
                  ...
                  Solicitudes de Reset de ContraseÃ±a
                      ...
                      <div key={sol.id} className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
                        ...
                        <Button 
                          ...
                          onClick={async () => {
                            ...
                            if (exito) {
                              toast.success(`ContraseÃ±a de ${sol.usuarioNombre} reseteada a "123456"`);
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg">
                  <div>
                    <p className="font-medium text-green-700">Backup AutomÃ¡tico</p>
        ...
        <TabsContent value="configuracion" className="space-y-6">
          {/* Nuevas Herramientas de GestiÃ³n */}
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-4 border border-blue-200">
            <h3 className="text-sm font-semibold text-gray-700 mb-3 flex items-center gap-2">
              <Shield className="w-4 h-4 text-blue-600" />
              HERRAMIENTAS DE GESTIÃ“N - MODO DIOS
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <Card className="cursor-pointer hover:shadow-lg transition-all border-2 border-blue-200 hover:border-blue-400" onClick={() => onNavegar('gestion-usuarios')}>
                <CardContent className="p-4 flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold">GestiÃ³n de Usuarios</h4>
              ...
              <Card className="cursor-pointer hover:shadow-lg transition-all border-2 border-purple-200 hover:border-purple-400" onClick={() => onNavegar('cuestionarios')}>
                <CardContent className="p-4 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">Crear encuestas con mÃºltiples tipos de preguntas</p>
                  </div>
                </CardContent>
              </Card>
            </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                      Cambiar imagen de fondo, tÃ­tulo y logo del login
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                      Configurar polÃ­ticas de seguridad y acceso
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                      Configurar canales de notificaciÃ³n (Email, WhatsApp)
                    </p>
                  </div>
                </div>
              </CardContent>
        ...
        <TabsContent value="mantenimiento" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-gray-500">
                  Limpia la cachÃ© y archivos temporales del sistema para mejorar el rendimiento.
                </p>
                <Button 
                  variant="outline" 
                  className="w-full"
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-gray-500">
                  Realiza mantenimiento y optimizaciÃ³n de la base de datos.
                </p>
                <div className="flex gap-2">
                  <Button 
                    variant="outline" 
                    className="flex-1"
                    onClick={() => toast.info('OptimizaciÃ³n iniciada')}
                  >
              ...
              <CardContent>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between py-2 border-b">
                    <span className="text-gray-500">VersiÃ³n</span>
                    <span className="font-medium">{estadoSistema.version}</span>
                  </div>
                  <div className="flex justify-between py-2 border-b">
                    <span className="text-gray-500">Entorno</span>
                    <span className="font-medium">ProducciÃ³n</span>
                  </div>
                  <div className="flex justify-between py-2 border-b">
                    <span className="text-gray-500">Ãšltimo Reinicio</span>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Button 
                  variant="destructive" 
                  className="w-full"
                  onClick={() => toast.error('FunciÃ³n deshabilitada en producciÃ³n')}
                >
